...
public class InserirDisc2 extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public InserirDisc2(Aluno aln, Disciplina disc, Boletim boletim, List<Disciplina> disciplinas) {
		...
		JLabel lblDisciplina = new JLabel("Disciplina 2");
		...
		cadastrarDisc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				InserirDisc3 finserirdisc = new InserirDisc3(aln, disc, boletim, disciplinas);
