...
public class InserirDisc3 extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public InserirDisc3(Aluno aln, Disciplina disc, Boletim boletim, List<Disciplina> disciplinas) {
		...
		JLabel lblDisciplina = new JLabel("Disciplina 3");
		...
		cadastrarDisc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				InserirDisc4 finserirdisc = new InserirDisc4(aln, disc, boletim, disciplinas);
